...
const owner = ["621633393431412736","761658231981604865","","","",]; // اي دي الاونر اللي يقدر يتحكم في اوامر الاونر
...
client.user.setActivity('Do System', { type: 'WATCHING' }) // حط الحاله اللي انت عايز
...
Uptime: ${seconds}s ${minutes}m ${hours}h ${days}d\`\`\``
  ...
  .setAuthor(`Admin Commands:`, client.user.displayAvatarURL({dynamic : true}))
    ...
    {
      name: `${prefix}say`, 
      value: `بيخلي البوت يكتب`
},
    {
      name: `${prefix}addemoji`, 
      value: `اضافه ايموجي للسيرفر`  
...
},
     {
      ...
      {
      name: `${prefix}hide`, 
      value: `يخلي الروم خاص`
},
      {
      name: `${prefix}show`, 
      value: `يخلي الروم يشوفها الجميع`
},
      {
      name: `${prefix}lock`, 
      value: `يقفل الروم`
      ...
      value: `يعطي تايم اوت`
          ...
          {
      name: `${prefix}role`, 
      value: `اعطاء احد رتبه`
},
          {
      name: `${prefix}role removed`, 
      value: `ازاله رتبه من احد`
},
          {
      name: `${prefix}hide-all`, 
      value: `اخفاء كل الرومات`
},
          {
      name: `${prefix}hshow-all`, 
      value: `اظهار كل الرومات`
},
          {
      name: `${prefix}dmuser`, 
      value: `ارسال رساله لاحد في الخاص`
},
          {
      name: `${prefix}set-channel`, 
      value: `تحديد تسجيلات التقديم على الاداره`
},
          {
      name: `${prefix}set-role`,
      value: `تحديد رتبه الاداره لما شخص يتقبل ياخدها`
},
          {
      name: `${prefix}set-highrole   `,
      value: `تحديد رتبه للاداره الرفض والقبول`
},
           {
      name: `${prefix}setup`,
      value: `تنزيل تقديم الاداره`
},
          {
      name: `${prefix}members`,
      value: `حاله الاعضاء`
          ...
          {
      name: `${prefix}all-unban`,
      value: `إلغاء حظر الكل`
},
           {
      name: `${prefix}setnick`,
      value: `تغيير اسم احد`
...
let embed_1 = new MessageEmbed()
   ...
   .setAuthor(`General Commands:`, client.user.displayAvatarURL({dynamic : true}))
      ...
      .setTimestamp()
        .addFields([
    {
      name: `${prefix}top-credits`, 
      value: `يخليك تشوف توب 10 على الكريدت`
},
    {
      name: `${prefix}tax`, 
      value: `يحسب لك ضريبه بروبوت`  
 
}, 
      {
      name: `${prefix}ping `, 
      value: `يوريك بنج البوت`
}, 
          {
      name: `${prefix}developer`, 
      value: `يوريك معلومات عن مطور البوت`  
 
},
          {
      name: `${prefix}user `, 
      value: `معلومات عنك انت`  
 
}, 
          {
      name: `${prefix}avatar  `, 
      value: `يجيب لك الافاتار بتاعك`  
 
}, 
          {
      name: `${prefix}avatar server`, 
      value: `يجيب افاتار السيرفر بس من دون تحميل`  
 
}, 
          {
      name: `${prefix}invite `, 
      value: `يجيب لك انفايت للبوت بتاعك`  
